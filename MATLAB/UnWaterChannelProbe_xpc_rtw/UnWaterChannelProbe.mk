...
MODEL           = UnWaterChannelProbe
MODULES         = UnWaterChannelProbe_capi.c UnWaterChannelProbe_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = UnWaterChannelProbe.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\newton\AeroFS\NESL_Software\electrosense\MATLAB
...
MODELLIB                  = UnWaterChannelProbelib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = UnWaterChannelProbe_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\UnWaterChannelProbe_xpc_rtw
