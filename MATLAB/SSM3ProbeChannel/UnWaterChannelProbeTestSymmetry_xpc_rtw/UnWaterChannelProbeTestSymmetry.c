...
void UnWaterChannelProbeTestSymmetry_initialize(boolean_T firstTime)
{
  ...
  /* external mode info */
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.checksums[0] = (1769428753U);
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.checksums[1] = (3339771386U);
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.checksums[2] = (3112705464U);
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.checksums[3] = (3697642314U);
