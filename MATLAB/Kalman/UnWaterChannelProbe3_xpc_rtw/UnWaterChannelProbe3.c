...
void UnWaterChannelProbe3_initialize(boolean_T firstTime)
{
  ...
  /* external mode info */
  UnWaterChannelProbe3_rtM->Sizes.checksums[0] = (3339669057U);
  UnWaterChannelProbe3_rtM->Sizes.checksums[1] = (2305643294U);
  UnWaterChannelProbe3_rtM->Sizes.checksums[2] = (2214948961U);
  UnWaterChannelProbe3_rtM->Sizes.checksums[3] = (2029267193U);
