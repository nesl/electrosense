...
void UnWaterChannelProbe3_initialize(boolean_T firstTime)
{
  ...
  /* external mode info */
  UnWaterChannelProbe3_rtM->Sizes.checksums[0] = (2076440648U);
  UnWaterChannelProbe3_rtM->Sizes.checksums[1] = (611704053U);
  UnWaterChannelProbe3_rtM->Sizes.checksums[2] = (1713239440U);
  UnWaterChannelProbe3_rtM->Sizes.checksums[3] = (3525419444U);
