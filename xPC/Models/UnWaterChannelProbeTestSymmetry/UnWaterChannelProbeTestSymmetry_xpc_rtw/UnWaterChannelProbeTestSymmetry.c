...
void UnWaterChannelProbeTestSymmetry_output(int_T tid)
{
  ...
  UnWaterChannelProbeTestSymmetry_Y.Outport[6] =
    UnWaterChannelProbeTestSymmetry_B.Gain7;
  UnWaterChannelProbeTestSymmetry_Y.Outport[7] =
    UnWaterChannelProbeTestSymmetry_B.SignalGenerator1;
...
void UnWaterChannelProbeTestSymmetry_initialize(boolean_T firstTime)
{
  ...
  /* external mode info */
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.checksums[0] = (1807537776U);
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.checksums[1] = (2602500741U);
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.checksums[2] = (635672932U);
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.checksums[3] = (11205098U);
...

  {
    ...
    UnWaterChannelProbeTestSymmetry_B.PCI6220AD1_o7 = 0.0;
    ...
    UnWaterChannelProbeTestSymmetry_B.RateTransition7 = 0.0;
    UnWaterChannelProbeTestSymmetry_B.Gain7 = 0.0;
...
void MdlInitializeSizes(void)
{
  ...
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.numY = (8);/* Number of model outputs */
  ...
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.numBlocks = (23);/* Number of blocks */
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.numBlockIO = (26);/* Number of block outputs */
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.numBlockPrms = (69);/* Sum of parameter "widths" */
}
    ...
    /* S-Function Block: <S1>/S-Function (scblock) */
    {
      ...
      if ((i = rl32eScopeExists(4)) == 0) {
        if ((i = rl32eDefScope(4,2)) != 0) {
          ...
          rl32eAddSignal(4, rl32eGetSignalNo("Gain7"));
