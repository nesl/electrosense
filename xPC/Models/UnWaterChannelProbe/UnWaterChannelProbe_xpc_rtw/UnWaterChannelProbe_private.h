 ...
 */
#ifndef RTW_HEADER_UnWaterChannelProbe_private_h_
#define RTW_HEADER_UnWaterChannelProbe_private_h_
#include "rtwtypes.h"
...
void UnWaterChannelProbe_output0(int_T tid);
void UnWaterChannelProbe_update0(int_T tid);
void UnWaterChannelProbe_output2(int_T tid);
void UnWaterChannelProbe_update2(int_T tid);

#endif                                 /* RTW_HEADER_UnWaterChannelProbe_private_h_ */
