...
MODEL           = UnWaterChannelProbeTestSymmetry
MODULES         = UnWaterChannelProbeTestSymmetry_capi.c UnWaterChannelProbeTestSymmetry_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c 
MAKEFILE        = UnWaterChannelProbeTestSymmetry.mk
...
MASTER_ANCHOR_DIR = 
START_DIR       = C:\Users\newton\AeroFS\NESL_Software\electrosense\xPC\Models\UnWaterChannelProbe3
S_FUNCTIONS     = adnipcim.c danipci671x.c xpcionim.c xpcionie.c
S_FUNCTIONS_LIB = 
NUMST           = 2
TID01EQ         = 1
NCSTATES        = 0
...
MULTITASKING    = 0
EXT_MODE        = 0
MEX_OPT_FILE    = -f "$(MATLAB_BIN)\$(ML_ARCH)\mexopts\msvc100freeopts.bat"
...
MODELLIB                  = UnWaterChannelProbeTestSymmetrylib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = UnWaterChannelProbeTestSymmetry_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\UnWaterChannelProbeTestSymmetry_xpc_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\newton\AeroFS\NESL_Software\electrosense\xPC\Models\UnWaterChannelProbeTestSymmetry
