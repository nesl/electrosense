...
MODEL           = xpcosc
MODULES         = rtGetInf.c rtGetNaN.c rt_logging.c rt_logging_mmi.c rt_matrx.c rt_nonfinite.c rt_printf.c rtw_modelmap_utils.c xpc_datatype_ground.c xpcosc_capi.c xpcosc_data.c 
MAKEFILE        = xpcosc.mk
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\xpcosc_xpc_rtw
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\newton\AeroFS\NESL_S~1\ELECTR~3\xPC\XPCPRO~1
