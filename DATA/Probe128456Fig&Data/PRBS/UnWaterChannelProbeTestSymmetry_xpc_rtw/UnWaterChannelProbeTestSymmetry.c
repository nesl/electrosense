...
void UnWaterChannelProbeTestSymmetry_initialize(boolean_T firstTime)
{
  ...
  /* external mode info */
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.checksums[0] = (4171629375U);
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.checksums[1] = (841542518U);
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.checksums[2] = (699577957U);
  UnWaterChannelProbeTestSymmetry_rtM->Sizes.checksums[3] = (2446774426U);
